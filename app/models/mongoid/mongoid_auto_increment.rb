        ...
        def initialize(sequence, collection_name, seed, step)
         ...
         def inc
          if defined?(::Mongoid::VERSION) && ::Mongoid::VERSION >= '5'
            ...
            collection.find_one_and_update(query,{"$inc" => { "number" => @step }},"new"=> true,"upsert"=> true,:return_document => :after)["number"]
          elsif defined?(::Mongoid::VERSION) && ::Mongoid::VERSION > '3' && ::Mongoid::VERSION < '5'
